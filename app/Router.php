...
class Router
{
    ...
    private static function checkRateLimit(string $method, string $path, array $rateLimit): void
    {
        ...
        try {
            ...
            $current = \App\Cache\RedisCache::Incr($key);
            if ($current === 1) {
                \App\Cache\RedisCache::Expire($key, $window);
            }
            if ($current > $limit) {
    ...
    private static function getRoutes(): array
    {
        return [
            'routes' => [
                ['GET',     '/',                   null                                                ],
                ['POST',    '/1/log',              \App\Handler\LogHandler::class,       [36000, 60]          ],
                ['DELETE',  '/1/log/{id}',         \App\Handler\LogHandler::class,       [36000, 60]          ],
                ['POST',    '/1/analyse',          \App\Handler\AnalyseHandler::class,   [36000, 60]          ],
                ['GET',     '/1/errors/rate',      \App\Handler\RateErrorHandler::class, [36000, 60]          ],
                ['GET',     '/1/limits',           \App\Handler\LimitsHandler::class,    [36000, 60]          ],
                ['GET',     '/1/filters',          \App\Handler\FiltersHandler::class,   [36000, 60]          ],
                ['GET',     '/1/raw/{id}',         \App\Handler\RawHandler::class,       [36000, 60]          ],
                ['GET',     '/1/raw/{id}/{filename:.+}', \App\Handler\RawHandler::class, [36000, 60]          ],
                ['GET',     '/1/log/{id}',         \App\Handler\LogMetaHandler::class,   [36000, 60]          ],
                ['GET',     '/1/insights/{id}',    \App\Handler\InsightsHandler::class,  [36000, 60]          ],
                ['GET',     '/1/ai/{id}',          \App\Handler\AIHandler::class,        [36000, 60]          ],
                ['POST',    '/1/ai/analyse',       \App\Handler\AIAnalyseHandler::class, [36000, 60]          ],

                ['POST',    '/v1/log',             \App\Handler\LogHandler::class,       [36000, 60]          ],
                ['DELETE',  '/v1/log/{id}',        \App\Handler\LogHandler::class,       [36000, 60]          ],
                ['POST',    '/v1/analyse',         \App\Handler\AnalyseHandler::class,   [36000, 60]          ],
                ['GET',     '/v1/errors/rate',     \App\Handler\RateErrorHandler::class, [36000, 60]          ],
                ['GET',     '/v1/limits',          \App\Handler\LimitsHandler::class,    [36000, 60]          ],
                ['GET',     '/v1/filters',         \App\Handler\FiltersHandler::class,   [36000, 60]          ],
                ['GET',     '/v1/raw/{id}',        \App\Handler\RawHandler::class,       [36000, 60]          ],
                ['GET',     '/v1/raw/{id}/{filename:.+}', \App\Handler\RawHandler::class, [36000, 60]          ],
                ['GET',     '/v1/log/{id}',        \App\Handler\LogMetaHandler::class,   [36000, 60]          ],
                ['GET',     '/v1/insights/{id}',   \App\Handler\InsightsHandler::class,  [36000, 60]          ],
                ['GET',     '/v1/ai/{id}',         \App\Handler\AIHandler::class,        [36000, 60]          ],
                ['POST',    '/v1/ai/analyse',      \App\Handler\AIAnalyseHandler::class, [36000, 60]          ],
            ],
