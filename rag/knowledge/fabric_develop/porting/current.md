...
- Fabric blog 上的 _Fabric for Minecraft 1.21.11_ 包含对 Fabric API 1.21.11 版本所做更改的概述。
- Minecraft blog 上的 _Minecraft: Java Edition 1.21.11_ 是 1.21.11 引入的功能的官方概览。
- Minecraft Wiki 上的《Java版1.21.11》是此次更新内容的非官方总结。
- YouTube 上的 slicedlime 的 Data & Resource Pack News in Minecraft 1.21.11 介绍了与更新模组的数据和资源包驱动内容相关的信息。
- NeoForge 的 _Minecraft 1.21.10 -> 1.21.11 Mod Migration Primer_ 介绍了从 1.21.10 迁移到 1.21.11，仅聚焦于原版代码的变更。
  - 请注意，链接的文章是第三方材料，不由 Fabric 维护。 其版权属于 @ChampionAsh5357，按 Creative Commons Attribution 4.0 International 的许可协议发布。
