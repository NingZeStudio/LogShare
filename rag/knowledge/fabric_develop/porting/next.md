...
这些文档讨论的是从 **1.21.11** 迁移到 **26.1** 的快照版本， 如果你是要迁移到 **1.21.11**，请参阅 迁移到 1.21.11。

注意如果你的模组还是在使用 Fabric 的 Yarn 映射，你首先需要将你的模组迁移到 Mojang 的官方映射然后再移植到 26.1。
...
- Fabric API 26.1 迁移指南列举了 Fabric API 在 26.1 中为匹配 Mojang 的名称而进行的更名。
- Minecraft Wiki 上的《Java版26.1》是此次更新内容的非官方总结。
- NeoForge 的 _Minecraft 1.21.11 -> 26.1 Mod Migration Primer_ 介绍了从 1.21.11 迁移到 26.1，仅聚焦于原版代码的变更。
