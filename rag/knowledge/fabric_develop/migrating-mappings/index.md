...
Mojang 近期宣布他们将要移除《Minecraft：Java 版》中的代码混淆，而 Fabric 项目随后公布了应对这一变化的计划。 如果你计划将模组更新到此版本，则需要在更新之前先迁移到 Mojang 的混淆映射。
...
- **Mojang 映射**：游戏官方的混淆映射，由 Mojang 于 2019 年发布，旨在帮助模组开发。 值得注意的是，Mojang 的混淆映射缺少参数名称和 Javadoc，因此一些用户还会在官方映射上叠加 Parchment。 例如，`Creeper` 就是一个 Mojang 映射。
