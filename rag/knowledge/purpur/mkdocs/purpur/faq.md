...
We have a downloads page on our website that's almost as majestic as my beard ![Billy's Majestic Beard](https://cdn.discordapp.com/emojis/768978823655063602.png?size=16). It is our user friendly front-end for our downloads API:

If you'd rather use the downloads API directly (for automation, scripts, or whatever) you can find the API endpoints listed on [the home page]().
...
Feature Request: /discussions/new
...
Yes! It's where the Purpur community resides. Don't be afraid to poke your head in and take a peek!
...
For the curious, you can view all the code changes on GitHub here: /tree/master/patches
...
Yes. The only time there's incompatibility is due to authors hard-coding support for CraftBukkit/Spigot, ignoring the existence of Paper and its forks. If you run into any bugs that you know are because of Purpur, [create a ticket](/issues/new) and/or [join our Discord server]() so we can take a look.
