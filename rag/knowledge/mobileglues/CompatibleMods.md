...
- Create 0.5.1j (Fabric / NeoForge, with flywheel batching/instancing backend supported 2)
- Timeless and Classics Zero (aka. TaCZ, Fabric)
- Physics Mod
- More to discover...3

1 Regarding shader compatibility, please refer to CompatibleShaders.md
...
3 Most of the mods that work on desktop should work on MobileGlues, but some mods may not work due to the immature status of this renderer and/or there's bugs/missing extensions in the underlying ES driver.
