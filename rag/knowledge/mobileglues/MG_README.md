...
See CompatibleShaders.md to see compatible Minecraft shaders.
See CompatibleMods.md to see compatible Minecraft mods.
...
1. Capable of running Minecraft Sodium mod;

2. Capable of rendering most minecraft shaders with Minecraft Iris mod or Optifine.

3. Capable of running some Minecraft mods with custom rendering routines, such as JourneyMap and Create.
...
**flat_hash_map** by **Malte Skarupke** - Boost Software License 1.0: github (a fork of skarupke/flat_hash_map, carrying a fix that lets the header be included on 32-bit targets)

## MobileGlues-plugin

**Miuix** by **compose-miuix-ui** - Apache License 2.0: github

**Jetpack Compose** by **Android Open Source Project (AOSP)** - Apache License 2.0: Android Developers

**AndroidX** by **Android Open Source Project (AOSP)** - Apache License 2.0: Android Developers

**kotlinx.coroutines** by **JetBrains** - Apache License 2.0: github

**Gson** by **Google** - Apache License 2.0: github
