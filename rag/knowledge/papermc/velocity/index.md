...
<LinkCard
    ...
    description="Information and tutorials regarding the administration of a Velocity proxy."
    href="/velocity/admin"
  />
<LinkCard
    title="Development"
    description="Information and tutorials for developers on how to create and expand on Velocity plugins."
    href="/velocity/dev"
  />
