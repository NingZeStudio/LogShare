...
This means that all the [`Audience`](jd:adventure:net.kyori.adventure.audience.Audience)
...
The [`ForwardingAudience`](jd:adventure:net.kyori.adventure.audience.ForwardingAudience)
wraps a collection of [`Audience`](jd:adventure:net.kyori.adventure.audience.Audience)
...
They are mostly used for sending other parts of the API to players. For example, you can send a [`Component`](jd:adventure:net.kyori.adventure.text.Component)
to a player using [`Audience#sendMessage(Component)`](jd:adventure:net.kyori.adventure.audience.Audience#sendMessage(net.kyori.adventure.text.Component)).
