...
**ParticleBuilder**
    ...
    Bukkit.getScheduler().runTaskLater(plugin,
      () -> particleBuilder.offset(-2.0, 0, 0).spawn(), 10);
    ```
**spawnParticle**
...
![Geyser base particle example](./assets/particles/geyser-base.webp)
...
![Geyser plume particle example](./assets/particles/geyser-plume.webp)
...
![Geyser particle example](./assets/particles/geyser.webp)
