...
using the API by using [Audience#showDialog(DialogLike)](jd:adventure:net.kyori.adventure.audience.Audience#showDialog(net.kyori.adventure.dialog.DialogLike)).
...
- The intended way of using [`Adventure#closeDialog()`](jd:adventure:net.kyori.adventure.audience.Audience#closeDialog()).
